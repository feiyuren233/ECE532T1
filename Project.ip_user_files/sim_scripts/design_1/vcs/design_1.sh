...
#
# Generated by Vivado on Wed Feb 06 23:03:31 EST 2019
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/cad1/Xilinx/Vivado/2018.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/cad1/Xilinx/Vivado/2018.1/data/xilinx_vip/include" \
    "$ref_dir//nfs/ug/homes-5/r/renfeiyu/Project/Project.srcs/sources_1/bd/design_1/ip/design_1_blk_mem_gen_0_0/design_1_blk_mem_gen_0_0_sim_netlist.v" \
